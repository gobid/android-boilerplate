...
public final class Prefs {
    ...
    public final static class Builder {
        ...
        public Builder setMode(final int mode) {
            if (mode == ContextWrapper.MODE_PRIVATE || mode == ContextWrapper.MODE_ENABLE_WRITE_AHEAD_LOGGING || mode == ContextWrapper.MODE_APPEND) {
                mMode = mode;
            } else {
                throw new RuntimeException("The mode in the SharedPreference can only be set too ContextWrapper.MODE_PRIVATE, ContextWrapper.MODE_ENABLE_WRITE_AHEAD_LOGGING or ContextWrapper.MODE_APPEND");
            }
